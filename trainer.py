...
def build_dynamic_courses(catalog_data):
    # الخريطة مخصصة تماماً للكتالوج الجديد (AI, BIO, CS, IT, IS, SWE)
    category_map = {
        "Software Engineering":    [1.0, 0.0, 0.0, 0.0],
        "Computer Science":        [0.9, 0.1, 0.0, 0.0],
        "Artificial Intelligence": [0.0, 1.0, 0.0, 0.0],
        "Bioinformatics":          [0.1, 0.9, 0.0, 0.0],
    ...
    for course in catalog_data:
        ...
        # لو القسم غير موجود يأخذ وزن محايد
