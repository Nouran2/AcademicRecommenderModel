...
app = FastAPI(title="Wanees Expert Academic System", version="5.1.0")
...
async def startup_event():
    ...
    if os.path.exists(MODEL_PATH):
        ...
        logger.info("✅ Wanees Engine Ready with 7D logic.")
...
async def recommend(student_id: str):
    ...
    if resp.status_code == 200:
        ...
        recs = [{"course_code": c.get("code"), "course_name": c.get("title"), "confidence": "100%", "score": 1.0, "tag": "Foundation Course"}]
